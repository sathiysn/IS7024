        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthDataSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GoalSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecommmendationSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthReport", x => x.HealthReportID);
                    table.ForeignKey(
                        name: "FK_HealthReport_User_UserID",
                        column: x => x.UserID,
                        principalTable: "User",
                        principalColumn: "UserID");
                });
